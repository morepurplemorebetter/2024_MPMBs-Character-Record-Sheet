...
function ApplyWildshape() {
	...
	if (theCrea.wildshapeString !== undefined && typeof theCrea.wildshapeString === "string") {
		...
		if (theCrea.vulnerabilities) {
			strTraits.push("##\u25C6 Vulnerabilities##. " + theCrea.vulnerabilities + ".");
		}
		if (theCrea.damage_resistances) {
			strTraits.push("##\u25C6 Damage Resistances##. " + theCrea.damage_resistances + ".");
		}
		if (theCrea.resistances) { // 2024 notation
			strTraits.push("##\u25C6 Resistances##. " + theCrea.resistances + ".");
		}
		...
		if (theCrea.immunities) { // 2024 notation
			strFeatures.push("##\u25C6 Immunities##. " + theCrea.immunities + ".");
		}
		//add actions
		if (theCrea.actions) {
...
function processToNotesPage(AddRemove, items, type, mainObj, parentObj, namesArr) {
	...
	for (var i = 0; i < items.length; i++) {
		...
		var noteDesc = "";
		if (noteObj.useDescriptionFull && fallback.descriptionFull) {
			noteDesc = ConvertToFirstPerson(
				formatDescriptionFull(fallback.descriptionFull, true),
