...
/*	-INFORMATION-
	...
	Sheet:		v24.0.15 and above (PHB'24)
*/
...
*/
	...
	*/
		...
		CHANGE:	v14.0.1 (onceXr+markedbox options added)
		...
		the sheet will determine what is most logical. This does not apply to magic items,
		as for magic items the sheet doesn't automatically set anything.
	*/
...
*/
	...
	but that is no longer the case in the 5.5e (2024) rules.
*/
...
*/
	...
	of the title line automatically: "PR" for everything except when
