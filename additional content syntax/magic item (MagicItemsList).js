...
/*	type // REQUIRED //
	...
	automatically add `action: [["bonus action", "Drink/Administer Potion"]]`.
...
*/
	...
	/*	excludeCheck // OPTIONAL //
		...
		3)	v [added in v14.0.13]
			...
			var v = {
				...
				isWeapon, // boolean, whether (true) or not (false) this attack is considered a weapon (in 2024 rules, this is `false` for natural attacks like Unarmed Strike)
				isMeleeWeapon, // boolean, whether (true) or not (false) this attack has a range of 'melee' and is considered a melee weapon attack (i.e. not natural attacks in 2024 rules)
				isRangedWeapon, // boolean, whether (true) or not (false) this attack has a range that doesn't include 'melee' and is considered a ranged weapon attack (i.e. not natural attacks in 2024 rules)
				isThrownWeapon, // boolean, whether (true) or not (false) this attack is a weapon and has the 'thrown' property
				isNaturalWeapon, // boolean, whether (true) or not (false) this attack has the type 'natural' (then `v.isWeapon === false`)
	...
	*/
		...
		descriptionChange: ["between", "Purple", "of Sparkles"],
	/*	descriptionChange // OPTIONAL //
		TYPE:	array or `false`
		USE:	what part of the magic item's description to add the name of the selected gear to
		CHANGE:	v14.0.16 (add `false` as eligible option to disable changing the description)

		You can either set this attribute to `false`, to an array, or not include it.

		If you set this attribute to `false`, the sheet will not change the description.

		If you set this to an array, it must have only strings entries,
		with the first one being a specific command:
		1. The first string determines how the name of the selected gear is added to the magic item's description.
			...
			1.5 "between"	// Add the name of selected gear between the 2nd and 3rd array entries
	...
	*/
	...
	/*	itemName1stPage // OPTIONAL //
		...
		This array must have only strings entries, with the first one being a specific command:
