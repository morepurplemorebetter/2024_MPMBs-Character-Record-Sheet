...
var Base_WeaponsList = {
	...
	"sorcerous burst": {
		...
		range: "60 ft",
		description: "*+1d8 for each roll of 8 (max +mod d8s); **can be Acid/Cold/Fire/Lightn./Pois./Psych/Thndr",
		abilitytodamage: false,
	},
	"starry wisp": {
		...
		damage: ["C", 8, "radiant"],
		range: "60 ft",
		description: "Target emits 10-ft radius Dim Light and can't be Invisible until my next turn ends",
		abilitytodamage: false,
	},
	"true strike": {
...
var Base_AmmoList = {
	...
	"flask": {
		name: "Flasks",
		sortname: "Flasks (1 pint)",
		source: [["SRD24", 97], ["PHB24", 225]],
		weight: 1,
		icon: "Flasks",
	},
	"handaxe": {
