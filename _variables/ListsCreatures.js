var Base_CreatureList = {
	// The four elementals (for magic items and legacy stuff)
	"air elemental": {
		name: "Air Elemental",
		nameAlt: ["Elemental, Air"],
		nameThis: "elemental",
		source: [["SRD24", 258], ["MM24", 13]],
		size: 2,
		type: "Elemental",
		alignment: "Neutral",
		ac: 15,
		...
		traits: [{
			name: "Air Form",
			description: "The [THIS] can enter a creature's space and stop there. It can move through a space as narrow as 1 inch without expending extra movement to do so.",
		}],
		actions: [{
			name: "Multiattack",
	...
	"earth elemental": {
		...
		actions: [{
			name: "Multiattack",
			description: "As an Attack action, the [THIS] can make two attacks, using Slam or Rock Launch in any combination.",
		}],
		traits: [{
			name: "Earth Glide",
			description: "The [THIS] can burrow through nonmagical, unworked earth and stone. While doing so, the elemental doesn't disturb the material it moves through.",
		}, {
			name: "Siege Monster",
	...
	"fire elemental": {
		...
		features: [{
			name: "Illumination",
			description: "The [THIS] sheds Bright Light in a 30-ft radius and Dim Light for an additional 30 ft.",
		}],
		actions: [{
			name: "Multiattack",
			description: "As an Attack action, the [THIS] can make two Burn attacks.",
		}],
		traits: [{
			name: "Fire Aura",
			description: "At the end of each of the [THIS]'s turns, each creature in a 10-ft Emanation originating from the [THIS] takes 1d10 Fire damage. Creatures and flammable objects in the Emanation start burning.",
		}, {
			name: "Fire Form",
			description: "The [THIS] can move through a space as narrow as 1 inch without expending extra movement to do so, and it can enter a creature's space and stop there. The first time it enters a creature's space on a turn, that creature takes 1d10 Fire damage.",
		}, {
			name: "Water Susceptibility",
			description: "The [THIS] takes 1d6 Cold damage for every 5 ft it moves in water or for every 1 gallon of water splashed on it.",
		}],
	},
	"water elemental": {
		...
		features: [{
			name: "Freeze",
			description: "If the [THIS] takes Cold damage, its Speed decreases by 20 ft until the end of its next turn.",
		}, {
			name: "Water Form",
			description: "The [THIS] can enter an enemy's space and stop there. It can move through a space as narrow as 1 inch without expending extra movement to do so.",
		}],
		actions: [{
			name: "Multiattack",
	...
	"ghast": {
		...
		traits: [{
			name: "Stench",
			description: "Any creature that starts its turn in a 5-ft Emanation originating from the [THIS] must succeed on a DC 10 Constitution save or be Poisoned until the start of its next turn. On a success, the target is immune to this [THIS]'s Stench for 24 hours.",
		}],
		actions: [{
			name: "Claw",
			description: "Creatures that aren't Undead that are hit by the [THIS]'s Claw attack must succeed on a DC 10 Constitution save or be Paralyzed until the end of their next turn.",
		}],
		attacks: [{
			name: "Bite",
			ability: 2,
			damage: [1, 8, "piercing"],
			range: "Melee (5 ft)",
			description: "+2d8 Necrotic damage",
		}, {
			name: "Claw",
			ability: 2,
			damage: [2, 6, "slashing"],
			range: "Melee (5 ft)",
			description: "Non-Undead: DC 10 Con save or Paralyzed until end of their next turn",
		}],
	},
	"ghoul": {
		name: "Ghoul",
		source: [["SRD24", 288], ["MM24", 132]],
		size: 3,
		type: "Undead",
		alignment: "Chaotic Evil",
		ac: 12,
		...
		actions: [{
			...
			name: "Claw",
			description: "Creatures that aren't Undead or Elves that are hit by the [THIS]'s Claw attack must succeed on a DC 10 Constitution save or be Paralyzed until the end of their next turn.",
		}],
		attacks: [{
			name: "Bite",
			ability: 2,
			...
			damage: [1, 4, "slashing"],
			range: "Melee (5 ft)",
			description: "Non-Undead/elf: DC 10 Con save or Paralyzed until end of their next turn",
		}],
	},
	"mummy": {
		name: "Mummy",
		source: [["SRD24", 309], ["MM24", 219]],
		size: [4, 3],
		type: "Undead",
		alignment: "Lawful Evil",
		ac: 11,
		...
		actions: [{
			name: "Multiattack",
			description: "As an Attack action, the [THIS] can make two Rotting Fist attacks and use Dreadful Glare.",
		}, {
			name: "Rotting Fist",
			description: "If the target hit is a creature, it is cursed. While cursed, the target can't regain HP, its HP maximum doesn't return to normal when finishing a Long Rest, and its HP maximum decreases by 3d6 every 24 hours that elapse. A creature dies and turns to dust if reduced to 0 HP by this attack.",
		}, {
			name: "Dreadful Glare",
			description: "One creature the [THIS] can see within 60 ft must succeed on a Wisdom save or be Frightened until the end of the [THIS]'s next turn. On a success, the target is immune to this [THIS]'s Dreadful Glare for 24 hours.",
		}],
		attacks: [{
			name: "Rotting Fist",
			ability: 1,
			...
			range: "Melee (5 ft)",
			description: "+3d6 Necrotic damage; Cursed on hit, see Rotting Fist",
		}, {
			name: "Dreadful Glare",
			ability: 6,
			damage: ["Wis save", "", "Frightened"],
			range: "60 ft",
			description: "Until the end of the mummy's next turn; On a success, immune for 24 hours",
			abilitytodamage: false,
			dc: true,
		}],
	},
	"wight": {
		...
		addMod: [{
			...
			text: "The wight adds its Proficiency Bonus to its Initiative rolls.",
		}],
		traits: [{
			name: "Sunlight Sensitivity",
			description: "While in sunlight, the [THIS] has Disadvantage on ability checks and attack rolls.",
		}],
		actions: [{
			name: "Multiattack",
			description: "As an Attack action, the [THIS] can make two attacks, using Necrotic Sword or Necrotic Bow in any combination. It can replace one attack with a use of Life Drain.",
		}, {
			name: "Life Drain",
			description: "One creature within 5 ft has to make a Constitution save or take Necrotic damage and have its HP maximum decrease by the damage taken. A Humanoid slain by this attack rises 24 hours later as a **Zombie** under the [THIS]'s control, unless the Humanoid is restored to life or its body is destroyed. The [THIS] can have no more than twelve zombies under its control at a time.",
		}],
		attacks: [{
			name: "Necrotic Sword",
			ability: 1,
			...
			damage: [1, 8, "necrotic"],
			range: "5 ft",
			description: "Con save to avoid; Also reduces target's HP maximum by damage taken",
			dc: true,
			modifiers: ["", -1],
		}],
	},
	...
	"nightmare": {
		...
		traits: [{
			...
			description: "The [THIS] can grant Resistance to Fire damage to a rider while it is on the [THIS].",
		}, {
			name: "Illumination",
			description: "The [THIS] sheds Bright Light in a 10-ft radius and Dim Light for an additional 10 ft.",
		}],
	...
	"pegasus": {
		...
		attacks: [{
			...
			damage: [1, 6, "bludgeoning"],
			range: "Melee (5 ft)",
			description: "+2d4 Radiant damage",
		}],
	},
	// Golems and other Constructs
	"homunculus": {
		name: "Homunculus",
		source: [["SRD24", 299], ["MM24", 172]],
		size: 5,
		type: "Construct",
		alignment: "Neutral",
		ac: 13,
		...
		traits: [{
			...
			description: "While the [THIS] is on the same plane of existence as its master, the two of them can communicate telepathically with each other.",
		}],
		actions: [{
			name: "Bite",
			description: "When the [THIS] hits its Bite attack, the target must succeed on a DC 12 Constitution save or be Poisoned until the end of the [THIS]'s next turn. If it fails the save by 5 or more, it is instead Poisoned for 1 minute. While Poisoned, the target is also Unconscious, which ends early if the target takes damage.",
		}],
		attacks: [{
			name: "Bite",
			ability: 2,
			damage: [1, "", "piercing"],
			range: "Melee (5 ft)",
			description: "DC 12 Con save or Poisoned \x26 Unconscious until end of next turn",
			abilitytodamage: false,
		}],
	},
	"clay golem": {
		...
		addMod: [{
			type: "skill", field: "Init", mod: "Prof",
			text: "The golem adds its Proficiency Bonus to its Initiative rolls.",
		}],
		features: [{
			...
			name: "Immutable Form",
			description: "The [THIS] can't shape-shift.",
		}, {
			name: "Magic Resistance",
			description: "The [THIS] has Advantage on saves against spells and magical effects.",
		}],
		traits: [{
			name: "Berserk",
			description: "Whenever the [THIS] starts its turn Bloodied, roll 1d6. On a 6, it goes berserk. On each of its turns while berserk, it attacks the nearest creature it can see. If no creature is near enough to move to and attack, it attacks an object. Once berserk, it remains so until it is destroyed or is no longer Bloodied.",
		}],
		actions: [{
			name: "Multiattack",
			description: "As an Attack action, the [THIS] can make two Slam attacks, or three Slam attacks if it used Hasten this turn.",
		}, {
			name: "Hasten (Recharge 5-6)",
			description: "As a Bonus Action, the [THIS] can take the Dash and Disengage actions.",
		}],
		attacks: [{
			name: "Slam",
			ability: 1,
	...
	"flesh golem": {
		...
		features: [{
			...
			description: "Whenever the [THIS] is subjected to Lightning damage, it regains a number of HP equal to the Lightning damage dealt.",
		}, {
			name: "Magic Resistance",
			description: "The [THIS] has Advantage on saves against spells and magical effects.",
		}],
		traits: [{
			name: "Berserk",
			description: "Whenever the [THIS] starts its turn Bloodied, roll 1d6. On a 6, it goes berserk. On each of its turns while berserk, it attacks the nearest creature it can see. If no creature is near enough to move to and attack, it attacks an object. Once berserk, it remains so until it is destroyed or is no longer Bloodied. Its creator, if within 60 ft of the berserk [THIS], can try to calm it by taking an action to make a DC 15 Charisma (Persuasion) check; the [THIS] must be able to hear its creator. On a success, the [THIS] ceases being berserk until the start of its next turn, at which point it resumes rolling for Berserk if it is still Bloodied.",
		}, {
	...
	"iron golem": {
		...
		attacksAction: 2,
		addMod: [{
			type: "skill", field: "Init", mod: "Prof*2",
			text: "The golem adds twice its Proficiency Bonus to its Initiative rolls.",
		}],
		features: [{
			name: "Fire Absorption",
			description: "Whenever the [THIS] is subjected to Fire damage, it regains a number of Hit Points equal to the Fire damage dealt.",
		}, {
			name: "Immutable Form",
			description: "The [THIS] can't shape-shift.",
		}, {
	...
	"stone golem": {
		...
		actions: [{
			name: "Multiattack",
			description: "As an Attack action, the [THIS] can make two attacks, using Slam or Force Bolt in any combination.",
		}, {
			name: "Slow (Recharge 5-6)",
			description: "As a Bonus Action, the [THIS] can cast *Slow*, requiring no spell components and using Constitution as its spellcasting ability.",
		}],
		attacks: [{
			name: "Slam",
			ability: 1,
			...
			range: typePF ? "120 ft (40-ft Cube)" : "120 ft",
			description: "Bonus Action; Up to 6 crea; Slowed: -2 AC/Dex save, Act or Bns, 1 atk, no React, 25% S spell fails; EoT save",
			abilitytodamage: false,
			dc: true,
			tooltip: "The golem casts the *Slow* spell, requiring no spell components and using Constitution as the spellcasting ability (spell save DC 17).",
		}],
	},
	"shield guardian": {
		name: "Shield Guardian",
		nameThis: "guardian",
		source: [["SRD24", 323], ["MM24", 277]],
		size: 2,
		type: "Construct",
		alignment: "Unaligned",
		ac: 17,
		...
		features: [{
			name: "Bound",
			description: "The [THIS] is magically bound to an amulet. While the [THIS] and its amulet are on the same plane of existence, the amulet's wearer can telepathically call the [THIS] to travel to it, and the [THIS] knows the distance and direction to the amulet. If the [THIS] is within 60 ft of the amulet's wearer, half of any damage the wearer takes (round up) is transferred to the [THIS].",
		}, {
			name: "Regeneration",
			description: typePF ? "Regains 10 HP at the start of each of its turns if it has at least 1 HP." : "Heals 10 HP at the start of its turns if it has at least 1 HP.",
		}],
		traits: [{
			name: "Spell Storing",
			description: "A spellcaster who wears the [THIS]'s amulet can cause the [THIS] to store one spell of level 4 or lower. To do so, the wearer must cast the spell on the [THIS] while within 5 ft of it. The spell has no effect but is stored within the [THIS]. Any previously stored spell is lost when a new spell is stored. The [THIS] can cast the spell stored with any parameters set by the original caster, requiring no spell components and using the caster's spellcasting ability. The stored spell is then lost.",
		}],
		actions: [{
			name: "Multiattack",
			description: typePF ? "Two Fist attacks as an Attack action." : "As an Attack action, the [THIS] can make two Fist attacks.",
		}, {
			name: "Protection",
			description: "As a Reaction when an attack hits the wearer of the [THIS]'s amulet while within 5 ft of the [THIS], the [THIS] can give the wearer +5 to AC until the start of the [THIS]'s next turn. This works against the triggering attack, possibly causing it to miss.",
		}],
		attacks: [{
			name: "Fist",
			ability: 1,
