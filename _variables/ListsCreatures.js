var Base_CreatureList = {
	...
	"clay golem": {
		...
		attacks: [{
			...
			damage: [1, 10, "bludgeoning"],
			range: "Melee (5 ft)",
			description: "+1d12 Acid damage, which also reduces target's max HP; 2 Slams as an Action (3 if Hasten)",
		}],
	},
	"flesh golem": {
		name: "Flesh Golem",
		...
		features: [{
			...
			description: "Whenever the [THIS] is subjected to Lightning damage, it regains a number of Hit Points equal to the Lightning damage dealt.",
		}, {
			name: "Magic Resistance",
			description: "The [THIS] has Advantage on saves against spells and magical effects.",
		}],
